            ...
            <div id="container">
                <div id="header-wp">
                    ...
                    <div id="head-body" class="clearfix">
                        <div class="wp-inner">
                            <a href="?page=home" title="" id="logo" class="fl-left"><img style="width: 200px;" src="public/images/Logo.png"/></a>
                            ...
                            <div id="action-wp" class="fl-right">
                                <div id="advisory-wp" class="fl-left">
                                    ...
                                    <span class="phone">0931.295.731</span>
                                </div>
